...
export default function LabProfileClient({ id }: { id: string }) {
  ...
  useEffect(() => {
    ...
    const loadOpportunity = async () => {
      try {
        ...
        if (!isMounted) return;
        const found = data.opportunities.find((item) => item.id === id);
        if (!found) {
        ...
        try {
          const response = await fetch(
            `/api/research-opportunities?id=${encodeURIComponent(id)}`
          );
          if (!response.ok) {
        ...
        <div className="main-content">
          ...
          <div className="right-column">
            <div className="right-buttons">
              ...
              <Link href="/directory" className="back-button">
